     ...
     <section className="c">
        ...
        <div className="space-y-4 py-20">
            ...
            <div className=" max-w-5xl mx-auto ">
                <div className=" flex flex-wrap justify-evenly items-center gap-4">
                {
                    toolsEntries.map((entry)=>(
                        <div key={entry.id} className="w-full border grid place-content-center text-center md:w-64 rounded-lg px-4 py-8">
                            <Image src={entry.img[0]} height={400} width={400} alt={`${entry.title} logo`} className="object-cover size-18 mx-auto"/>
            ...
            <div className="w-full md:w-4/12 md:ml-auto  ">
                <p className="text-3xl">
                    Tech savvy and adaptable. I can integrate into your existing systems or help you set them up from scratch.
                </p>
            </div>
